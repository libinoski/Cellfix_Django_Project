...
urlpatterns = [
    ...
    path('customerlogin', LoginView.as_view(template_name='mobile/customerlogin.html'),name='customerlogin'),
    path('mechaniclogin', LoginView.as_view(template_name='mobile/mechaniclogin.html'),name='mechaniclogin'),
    path('adminlogin', LoginView.as_view(template_name='mobile/adminlogin.html'),name='adminlogin'),
    ...
    path('logout', LogoutView.as_view(template_name='mobile/index.html'),name='logout'),
