...
def customerclick_view(request):
    if request.user.is_authenticated:
        return HttpResponseRedirect('afterlogin')
    return render(request,'mobile/customerclick.html')

#for showing signup/login button for mechanics
def mechanicsclick_view(request):
    if request.user.is_authenticated:
        return HttpResponseRedirect('afterlogin')
    return render(request,'mobile/mechanicsclick.html')
...
def customer_signup_view(request):
    ...
    return render(request,'mobile/customersignup.html',context=mydict)
...
def mechanic_signup_view(request):
    ...
    return render(request,'mobile/mechanicsignup.html',context=mydict)
...
def afterlogin_view(request):
    if is_customer(request.user):
        ...
        if accountapproval:
            ...
            return render(request,'mobile/mechanic_wait_for_approval.html')
    else:
...
def admin_dashboard_view(request):
    ...
    return render(request,'mobile/admin_dashboard.html',context=dict)


@login_required(login_url='adminlogin')
def admin_customer_view(request):
    return render(request,'mobile/admin_customer.html')

@login_required(login_url='adminlogin')
def admin_view_customer_view(request):
    customers=models.Customer.objects.all()
    return render(request,'mobile/admin_view_customer.html',{'customers':customers})
...
def update_customer_view(request,pk):
    ...
    if request.method=='POST':
        ...
        if userForm.is_valid() and customerForm.is_valid():
            ...
            customerForm.save()
            return redirect('admin-view-customer')
    return render(request,'mobile/update_customer.html',context=mydict)
...
def admin_add_customer_view(request):
    ...
    return render(request,'mobile/admin_add_customer.html',context=mydict)
...
def admin_view_customer_enquiry_view(request):
    ...
    for enq in enquiry:
        customer=models.Customer.objects.get(id=enq.customer_id)
        customers.append(customer)
    return render(request,'mobile/admin_view_customer_enquiry.html',{'data':zip(customers,enquiry)})
...
def admin_view_customer_invoice_view(request):
    ...
    for enq in enquiry:
        ...
        customer=models.Customer.objects.get(id=enq['customer_id'])
        customers.append(customer)
    return render(request,'mobile/admin_view_customer_invoice.html',{'data':zip(customers,enquiry)})

@login_required(login_url='adminlogin')
def admin_mechanic_view(request):
    return render(request,'mobile/admin_mechanic.html')


@login_required(login_url='adminlogin')
def admin_approve_mechanic_view(request):
    mechanics=models.Mechanic.objects.all().filter(status=False)
    return render(request,'mobile/admin_approve_mechanic.html',{'mechanics':mechanics})
...
def approve_mechanic_view(request,pk):
    ...
    return render(request,'mobile/admin_approve_mechanic_details.html',{'mechanicSalary':mechanicSalary})
...
def admin_add_mechanic_view(request):
    ...
    return render(request,'mobile/admin_add_mechanic.html',context=mydict)


@login_required(login_url='adminlogin')
def admin_view_mechanic_view(request):
    mechanics=models.Mechanic.objects.all()
    return render(request,'mobile/admin_view_mechanic.html',{'mechanics':mechanics})
...
def update_mechanic_view(request,pk):
    ...
    if request.method=='POST':
        ...
        if userForm.is_valid() and mechanicForm.is_valid():
            ...
            mechanicForm.save()
            return redirect('admin-view-mechanic')
    return render(request,'mobile/update_mechanic.html',context=mydict)

@login_required(login_url='adminlogin')
def admin_view_mechanic_salary_view(request):
    mechanics=models.Mechanic.objects.all()
    return render(request,'mobile/admin_view_mechanic_salary.html',{'mechanics':mechanics})
...
def admin_request_view(request):
    return render(request,'mobile/admin_request.html')
...
def admin_view_request_view(request):
    ...
    for enq in enquiry:
        customer=models.Customer.objects.get(id=enq.customer_id)
        customers.append(customer)
    return render(request,'mobile/admin_view_request.html',{'data':zip(customers,enquiry)})
...
def change_status_view(request,pk):
    ...
    return render(request,'mobile/admin_approve_request_details.html',{'adminenquiry':adminenquiry})
...
def admin_add_request_view(request):
    ...
    if request.method=='POST':
        ...
        if enquiry.is_valid() and adminenquiry.is_valid():
            ...
            print("form is invalid")
        return HttpResponseRedirect('admin-view-request')
    return render(request,'mobile/admin_add_request.html',context=mydict)

@login_required(login_url='adminlogin')
def admin_approve_request_view(request):
    enquiry=models.Request.objects.all().filter(status='Pending')
    return render(request,'mobile/admin_approve_request.html',{'enquiry':enquiry})
...
def admin_view_service_cost_view(request):
    ...
    for enq in enquiry:
        ...
        customers.append(customer)
    print(customers)
    return render(request,'mobile/admin_view_service_cost.html',{'data':zip(customers,enquiry)})
...
def update_cost_view(request,pk):
    ...
    return render(request,'mobile/update_cost.html',{'updateCostForm':updateCostForm})



@login_required(login_url='adminlogin')
def admin_mechanic_attendance_view(request):
    return render(request,'mobile/admin_mechanic_attendance.html')
...
def admin_take_attendance_view(request):
    ...
    if request.method=='POST':
        ...
        if form.is_valid():
            ...
            print('form invalid')
    return render(request,'mobile/admin_take_attendance.html',{'mechanics':mechanics,'aform':aform})
...
def admin_view_attendance_view(request):
    ...
    if request.method=='POST':
        ...
        if form.is_valid():
            ...
            return render(request,'mobile/admin_view_attendance_page.html',{'mylist':mylist,'date':date})
        else:
            print('form invalid')
    return render(request,'mobile/admin_view_attendance_ask_date.html',{'form':form})
...
def admin_report_view(request):
    ...
    return render(request,'mobile/admin_report.html',context=dict)


@login_required(login_url='adminlogin')
def admin_feedback_view(request):
    feedback=models.Feedback.objects.all().order_by('-id')
    return render(request,'mobile/admin_feedback.html',{'feedback':feedback})
...
def customer_dashboard_view(request):
    ...
    return render(request,'mobile/customer_dashboard.html',context=dict)
...
def customer_request_view(request):
    customer=models.Customer.objects.get(user_id=request.user.id)
    return render(request,'mobile/customer_request.html',{'customer':customer})
...
def customer_view_request_view(request):
    ...
    return render(request,'mobile/customer_view_request.html',{'customer':customer,'enquiries':enquiries})
...
def customer_view_approved_request_view(request):
    ...
    return render(request,'mobile/customer_view_approved_request.html',{'customer':customer,'enquiries':enquiries})
...
def customer_view_approved_request_invoice_view(request):
    customer=models.Customer.objects.get(user_id=request.user.id)
    enquiries=models.Request.objects.all().filter(customer_id=customer.id).exclude(status='Pending')
    return render(request,'mobile/customer_view_approved_request_invoice.html',{'customer':customer,'enquiries':enquiries})
...
def customer_add_request_view(request):
    ...
    return render(request,'mobile/customer_add_request.html',{'enquiry':enquiry,'customer':customer})
...
def customer_profile_view(request):
    customer=models.Customer.objects.get(user_id=request.user.id)
    return render(request,'mobile/customer_profile.html',{'customer':customer})
...
def edit_customer_profile_view(request):
    ...
    return render(request,'mobile/edit_customer_profile.html',context=mydict)
...
def customer_invoice_view(request):
    customer=models.Customer.objects.get(user_id=request.user.id)
    enquiries=models.Request.objects.all().filter(customer_id=customer.id).exclude(status='Pending')
    return render(request,'mobile/customer_invoice.html',{'customer':customer,'enquiries':enquiries})
...
def customer_feedback_view(request):
    ...
    if request.method=='POST':
        ...
        if feedback.is_valid():
            ...
            print("form is invalid")
        return render(request,'mobile/feedback_sent_by_customer.html',{'customer':customer})
    return render(request,'mobile/customer_feedback.html',{'feedback':feedback,'customer':customer})
#============================================================================================
...
def mechanic_dashboard_view(request):
    ...
    return render(request,'mobile/mechanic_dashboard.html',context=dict)
...
def mechanic_work_assigned_view(request):
    ...
    return render(request,'mobile/mechanic_work_assigned.html',{'works':works,'mechanic':mechanic})
...
def mechanic_update_status_view(request,pk):
    ...
    return render(request,'mobile/mechanic_update_status.html',{'updateStatus':updateStatus,'mechanic':mechanic})
...
def mechanic_attendance_view(request):
    ...
    return render(request,'mobile/mechanic_view_attendance.html',{'attendaces':attendaces,'mechanic':mechanic})
...
def mechanic_feedback_view(request):
    ...
    if request.method=='POST':
        ...
        if feedback.is_valid():
            ...
            print("form is invalid")
        return render(request,'mobile/feedback_sent.html',{'mechanic':mechanic})
    return render(request,'mobile/mechanic_feedback.html',{'feedback':feedback,'mechanic':mechanic})
...
def mechanic_salary_view(request):
    ...
    return render(request,'mobile/mechanic_salary.html',{'workdone':workdone,'mechanic':mechanic})

@login_required(login_url='mechaniclogin')
@user_passes_test(is_mechanic)
def mechanic_profile_view(request):
    mechanic=models.Mechanic.objects.get(user_id=request.user.id)
    return render(request,'mobile/mechanic_profile.html',{'mechanic':mechanic})
...
def edit_mechanic_profile_view(request):
    ...
    return render(request,'mobile/edit_mechanic_profile.html',context=mydict)
...
def aboutus_view(request):
    return render(request,'mobile/aboutus.html')
...
def contactus_view(request):
    ...
    if request.method == 'POST':
        ...
        if sub.is_valid():
            ...
            return render(request, 'mobile/contactussuccess.html')
    return render(request, 'mobile/contactus.html', {'form':sub})
