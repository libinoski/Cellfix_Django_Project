...
class Request(models.Model):
    cat=(('low end device','low end device'),('mid range device','mid range device'),('top end model','top end model'),('flagship','flagship'))
    category=models.CharField(max_length=50,choices=cat)

    mobile_no=models.PositiveIntegerField(null=False)
    mobile_name = models.CharField(max_length=40,null=False)
    mobile_model = models.CharField(max_length=40,null=False)
    mobile_brand = models.CharField(max_length=40,null=False)
